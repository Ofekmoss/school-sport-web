define(["templates/principal-approval", "services/access", "services/products", "dialog", "utils"],
    function (templates, Access, Products, Dialog, utils) {
        ...
        function readConfirmations(comp, callback) {
            Vue.http.get('/api/v2/registration/confirmations').then(function (resp) {
                ...
                var rawValue = allConfirmations['principal-teams'];
                if (rawValue) {
                            ...
                            .then(
                                function (resp) {
                                    ...
                                    for (var i = 0; i < resp.body.length; i++) {
                                        ...
                                        if (team.active && (team.approved & Approval) === 0) {
                                            comp.approveCount++;
                                        }
        ...
        var PrincipalApprovalComponent = Vue.extend({
            ...
            methods: {
                ...
                confirm: function () {
                    ...
                    Vue.http.post('/api/v2/registration/league/teams/approve/principal', selectedTeamIds)
                        .then(
                            function (resp) {
                                Vue.http.post('/api/v2/registration/club/teams/approve/principal', selectedTeamIds).then(function (resp) {
