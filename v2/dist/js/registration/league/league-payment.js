define(["templates/registration", "services/access", "services/products", "dialog", "utils"], function (templates, Access, Products, Dialog, utils) {
    ...
    var RegistrationLeaguePaymentComponent = Vue.extend({
        ...
        computed: {
            canPay: function () {
                if (this.payment == null || this.payment.order != null || this.payment.method == null || this.payment.payerName == null || this.payment.payerName.length === 0) {
                    return false;
                }
                                ...
                                Dialog.open("general/message-box",
                                    {
                                        ...
                                        "6. אישור סופי של הקבוצות ישלח למייל " + comp.team.teacher.email + "<br/>" +
                                            ...
                                            "8. לשאלות בנוגע להרשמה ניתן לפנות לרכזת אליפות התיכוניים " +
                                        "<br/>&nbsp;&nbsp; במייל orit@schoolsport.org.il <br/>&nbsp;&nbsp; בנייד 054-4590173"
                                    }, function () {
                                        comp.next();
                                    });
                            },
