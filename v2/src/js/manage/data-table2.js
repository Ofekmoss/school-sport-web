define(["templates/manage", "utils", "views"], function (templates, utils, views) {
    ...
    var DataTable2 = Vue.extend({
        ...
        methods: {
            ...
            sort: function (col) {
                ...
                if (col.sort == 'a') {
                    ...
                    this.rawData.sort(function (item1, item2) {
                        var i1 = getValue(item1, col, true);
                        var i2 = getValue(item2, col, true);
                        if (i1 == i2) {
                            return 0;
                        }
            ...
            getValue: function(record, column, usedForSort) {
                if (typeof usedForSort === 'undefined' || usedForSort == null)
                    usedForSort = false;
