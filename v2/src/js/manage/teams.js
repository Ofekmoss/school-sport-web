define(["templates/manage", "manage/dal", "utils", "dialog",
    ...
    var columns = [
        ...
        {
            key: 'Manager.Name',
            name: 'מנהל/ת מקצועי/ת',
            active: false,
            filter: true,
            type: 'text'
        },{
            key: 'Manager.Email',
            name: 'אימייל מנהל/ת מקצועי/ת',
            active: false,
            type: 'text'
        },{
            key: 'Manager.PhoneNumber',
            name: 'טלפון מנהל/ת מקצועי/ת',
            active: false,
            type: 'text'
        },
        {
            ...
            key: 'Principal.Email',
            name: 'אימייל מנהל/ת בי"ס',
            active: false,
            type: 'text'
        },{
            key: 'Principal.PhoneNumber',
            name: 'טלפון מנהל/ת בי"ס',
            active: false,
            type: 'text'
        },
        {
