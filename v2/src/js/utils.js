    ...
    var utils = {
        ...
        formatDate: function(date, format) {
            ...
            if (year >= 1990 && year < 2100) {
                ...
                formatted = formatted.replace('YY', year.toString().substr(2));
                formatted = formatted.replace('HH', utils.padZero(date.getHours()));
                formatted = formatted.replace('mm', utils.padZero(date.getMinutes()));
                return formatted;
            }
            return '';
        },
        ...
        inactiveSeason: function(comp) {
            //console.log('user: ' + comp.user.season);
            //console.log('active: ' + comp.user.activeSeason);
