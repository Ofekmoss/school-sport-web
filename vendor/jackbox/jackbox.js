...
;(function($) {
    ...
    function init() {
        ...
        if(!isIE8) {
            ...
            preInside = $("<span />").addClass("jackbox-pre-inside").appendTo(preloader);
    ...
    function loadContent() {
        ...
        if(!firstActive && preInside) {

            preInside.addClass("jackbox-pre-ready");
            firstActive = true;
    ...
    function loadThumbs() {
        ...
        for(i = 0; i < leg; i++) {
            ...
            if(ww > thumbnailWidth && hh > thumbnailHeight) {
                ...
                pc = ww < hh ? hh / ww : ww / hh;

                ww = thumbnailWidth * pc;
                hh = thumbnailHeight * pc;
    ...
    function closing() {
        ...
        if(preInside) preInside.removeClass("jackbox-pre-ready");

        $this = isActive = isFullscreen = fromThumb = firstCheck = eventsAdded = arrowClicked = thumbsChecked = oldWidth = firstActive = null;
